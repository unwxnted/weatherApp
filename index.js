...
function fecthWeather(){
    const options = {
        method: 'GET',
        headers: {
            'X-RapidAPI-Key': '7e7df22d7emsh4038f1d297ccc83p11378fjsneba088e09085',
            'X-RapidAPI-Host': 'community-open-weather-map.p.rapidapi.com'
        }
    };
    
    fetch(`https://community-open-weather-map.p.rapidapi.com/weather?q=${cityInput}&units=imperial&mode=JSON`, options)
